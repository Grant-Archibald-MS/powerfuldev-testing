...
permalink: /learning/03-running-your-first-test
toc: true
sidebar:
  nav: "docs"
read_time: true
...
These instructions apply to the [inner ring](../context/ring-deployment-model) using a build from source strategy as these changes are included in the pac cli many of these steps are not required.
{: .notice--success}
